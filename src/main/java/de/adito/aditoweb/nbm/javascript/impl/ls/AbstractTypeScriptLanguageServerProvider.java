 ...
 */
abstract class AbstractTypeScriptLanguageServerProvider implements LanguageServerProvider
{
  private static final long STARTUP_DELAY = 10000;
  private static final RequestProcessor WORKER = new RequestProcessor(AbstractTypeScriptLanguageServerProvider.class.getName(), Integer.MAX_VALUE, false, false);
  private static final Logger LOGGER = Logger.getLogger(AbstractTypeScriptLanguageServerProvider.class.getName());
